          ...
          <div className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-3xl p-6 transform-gpu">
            <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl p-8 min-h-96">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-gray-400 text-sm">Imagenator Pro</div>
              </div>
              ...
              <div className="flex items-center justify-center">
                <div className="w-full h-48 bg-gradient-to-r from-black-500 via-gray-550 to-white rounded-2xl shadow-2xl shadow-blue-500/50 flex items-center justify-center">
